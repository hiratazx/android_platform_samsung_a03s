...
static const uint16_t g_u2CountryGroup1[] = {
	...
	COUNTRY_CODE_BV, COUNTRY_CODE_BZ, COUNTRY_CODE_CK, COUNTRY_CODE_CO,
	COUNTRY_CODE_CR, COUNTRY_CODE_DO, COUNTRY_CODE_EC, COUNTRY_CODE_FJ,
	COUNTRY_CODE_FK, COUNTRY_CODE_FM, COUNTRY_CODE_GD, COUNTRY_CODE_GI,
	COUNTRY_CODE_GS, COUNTRY_CODE_GY, COUNTRY_CODE_HN, COUNTRY_CODE_HT,
	...
	COUNTRY_CODE_TC, COUNTRY_CODE_TH, COUNTRY_CODE_TK, COUNTRY_CODE_TL,
	COUNTRY_CODE_TO, COUNTRY_CODE_TT, COUNTRY_CODE_TW, COUNTRY_CODE_UA,
...
static const uint16_t g_u2CountryGroup19[] = {
	COUNTRY_CODE_AE, COUNTRY_CODE_GB, COUNTRY_CODE_HK, COUNTRY_CODE_KR
};
static const uint16_t g_u2CountryGroup20[] = {
	COUNTRY_CODE_PR, COUNTRY_CODE_US
};
...
static const uint16_t g_u2CountryGroup23[] = {
	COUNTRY_CODE_AS, COUNTRY_CODE_GU, COUNTRY_CODE_MP, COUNTRY_CODE_UM,
	COUNTRY_CODE_VI
};
...
static const uint16_t g_u2CountryGroup26[] = {
	COUNTRY_CODE_BR, COUNTRY_CODE_PE
};
